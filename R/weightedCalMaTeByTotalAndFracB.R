###########################################################################/**
# @set "class=array"
# @RdocMethod weightedCalMaTeByTotalAndFracB
# @alias weightedCalMaTeByTotalAndFracB
# 
...
#         @seemethod "weightedCalMaTeByThetaAB".}
...
# }
#
# @examples "../incl/weightedCalMaTeByTotalAndFracB.Rex"
#
# \seealso{
#  To calibrate (thetaA,thetaB) data, 
#  see @seemethod "weightedCalMaTeByThetaAB".
# }
#*/###########################################################################
setMethodS3("weightedCalMaTeByTotalAndFracB", "array", function(data, ..., verbose=FALSE) {
  # Argument 'data':
  if (!is.array(data)) {
  ...
  verbose && enter(verbose, "weightedCalMaTeByTotalAndFracB()");
  ...
  dataC <- weightedCalMaTeByThetaAB(data, ..., verbose=verbose);  
  ...
  dataC;
}) # weightedCalMaTeByTotalAndFracB()


###########################################################################
# HISTORY:
# 2010-05-19
# o Created from weightedCalMaTeByASCN.R.
###########################################################################
